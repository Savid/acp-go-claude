...
selector='^(TestOrdinaryEnvironmentIsSanitizedAmbientCapture|TestOrdinaryExecutableResolutionPrecedesWorkingDirectoryChange|TestOrdinaryWaitPreservesBufferedOutput|TestOrdinaryNativeResultPreservesNaturalAndRevokedOutcomes)$'
