module github.com/savid/acp-go-claude

// Minimum Go language version required by consumers of this library.
go 1.25.0

// Toolchain used to build and develop this module. Does not raise the floor
// for downstream consumers; they only need a Go version >= the `go` directive.
toolchain go1.26.3
