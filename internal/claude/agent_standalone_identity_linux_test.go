...
func TestAgentStandaloneOwnerSessionKeyExactVector(t *testing.T) {
	...
	require.Equal(t, "standalone:7603440ca94f3cff92e393be043a6d5623be0ae57595aba56ea767f46fbb4dbe", key)
}
...
func TestAgentStandaloneOwnerCloseFailurePreventsPublication(t *testing.T) {
	...
	owner := agentStandaloneOwner{
		...
		StateRoot: agentStandaloneStateRoot{Path: "/srv/claude/close-fault", Dev: 1, Ino: 2},
	}
...
func TestAgentStandaloneOwnerTemporaryBusyRetriesUntilCanceled(t *testing.T) {
	...
	want := agentStandaloneOwner{
		...
		StateRoot: agentStandaloneStateRoot{Path: "/srv/claude/owner-temp-cancel", Dev: 1, Ino: 2},
	}
...
func TestAgentStandaloneDomainRebindOwnerTemporaryBusyCancelsWithoutUnlink(t *testing.T) {
	...
	want := agentStandaloneOwner{
		...
		StateRoot: agentStandaloneStateRoot{Path: "/srv/claude/domain-owner-temp", Dev: 1, Ino: 2},
	}
...
func TestAgentStandaloneRebindProbeFailureLeavesOldDomainRecordIntact(t *testing.T) {
	...
	want := agentStandaloneOwner{
		...
		StateRoot: agentStandaloneStateRoot{Path: "/srv/claude/probe-failure", Dev: 1, Ino: 2},
	}
...
func TestAgentStandaloneRebindRejectsOverlayFilesystemBeforeDomainMutation(t *testing.T) {
	...
	want := agentStandaloneOwner{
		...
		StateRoot: agentStandaloneStateRoot{Path: "/srv/claude/overlay-rebind", Dev: 1, Ino: 2},
	}
...
func TestAgentStandaloneDomainAuditCleansBoundMarkerTemporaryWithoutDispositionMutation(t *testing.T) {
	...
	owner := agentStandaloneOwner{
		...
		StateRoot: agentStandaloneStateRoot{Path: "/srv/claude/bound-marker-temp", Dev: 31, Ino: 32},
	}
...
func TestAgentStandaloneClaimRaceJoinsOwnerCleanupAndToleratesUnrelatedMarkerTemporary(t *testing.T) {
	...
	want := agentStandaloneOwner{
		...
		StateRoot: agentStandaloneStateRoot{Path: "/srv/claude/claim-race", Dev: 41, Ino: 42},
	}
...
func TestAgentStandaloneSameBootRebindRejectsSecondOwner(t *testing.T) {
	...
	owner := agentStandaloneOwner{
		...
		StateRoot: agentStandaloneStateRoot{Path: "/srv/claude/same-boot", Dev: 11, Ino: 12},
	}
	owners := createAgentStandaloneTestLock(t, directory, "owners.lock", ownerUID, ownerGID)
	require.NoError(t, owners.Close())
	...
	other := agentStandaloneOwner{
		...
		StateRoot: agentStandaloneStateRoot{Path: "/srv/claude/unrelated-bound", Dev: 13, Ino: 14},
	}
...
func TestAgentStandaloneSameBootRebindRejectsMatchingTask(t *testing.T) {
	...
	owner := agentStandaloneOwner{
		...
		StateRoot: agentStandaloneStateRoot{Path: "/srv/claude/same-boot-live-task", Dev: 21, Ino: 22},
	}
	owners := createAgentStandaloneTestLock(t, directory, "owners.lock", ownerUID, ownerGID)
	require.NoError(t, owners.Close())
...
func TestAgentStandaloneSameBootRebindRetainsUIDLockThroughDomainPublication(t *testing.T) {
	...
	owner := agentStandaloneOwner{
		...
		StateRoot: agentStandaloneStateRoot{Path: "/srv/claude/same-boot-publish", Dev: 31, Ino: 32},
	}
	owners := createAgentStandaloneTestLock(t, directory, "owners.lock", ownerUID, ownerGID)
	require.NoError(t, owners.Close())
...
func TestAgentStandaloneStateRootRequiresClaimedOwnerModeAndSupportsProtectedRoot(t *testing.T) {
	...
	base, err := os.MkdirTemp("/var/lib", "acp-go-claude-state-root-")
	require.NoError(t, err)
...
func TestAgentStandaloneEndToEndRetainsActiveAndNativeChildHasNoAuthorityFD(t *testing.T) {
	...
	require.NoError(t, validateTurnSupervisorAdoptedAuthorityDisposition(config, true, testRoot))
	wrongOwner := config
	wrongOwner.Isolation.StandaloneOwnerID = "another-owner"
	require.Error(t, validateTurnSupervisorAdoptedAuthorityDisposition(wrongOwner, true, testRoot))
	wrongGID := config
	wrongGID.Isolation.GID++
	require.Error(t, validateTurnSupervisorAdoptedAuthorityDisposition(wrongGID, true, testRoot))
...
func createAgentStandaloneMatchingDomainFixture(
	...
	want := agentStandaloneOwner{
		...
		StateRoot: agentStandaloneStateRoot{Path: "/srv/claude/matching-domain", Dev: 1, Ino: 2},
	}
