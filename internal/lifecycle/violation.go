...
const (
	...
	// version is not the exact supported scalar.
	...
	// terminal — a changed state, a changed carried member such as progress, or a
	// restated immutable at other than its first-sight value.
